...
#'
#' @seealso
#' \code{\link{.multi_factor_analysis}}, \code{\link{.one_factor_analysis}},
...
.manova_analysis <- function(x=NULL, g=NULL, formula=NULL, data=NULL,
  ...
  # Il gère les transformations (I, log, etc.) et les fonctions spéciales (cbind)
  # pour extraire correctement les variables réponses et explicatives.
  #
  # IMPORTANT: Si x et g sont déjà fournis (cas d'appel depuis m.test()),
  # on ne retraite PAS la formule car x est déjà une matrice extraite.
  #============================================================================
